...
export async function savelog(msg){
  ...
  const log = await helpers.query("INSERT INTO `logs` (`userId`, `sessionId`, `requestId`, `logPath`, `timestamp`) VALUES (?, ?, ?, ?, ?)", [msg.userId, msg.sessionId, msg.requestId, "Something: " + format(msg.logPath), Date.now()]);
